...
public class RoadMapDestAdress implements Serializable {
    private Integer roadMapDestAdressId;
    ...
    public Integer getRoadMapDestAdressId() {
        return roadMapDestAdressId;
    }

    public void setRoadMapDestAdressId(Integer roadMapDestAdressId) {
        this.roadMapDestAdressId = roadMapDestAdressId;
    }
    ...
    public boolean equals(Object that) {
        ...
        RoadMapDestAdress other = (RoadMapDestAdress) that;
        return (this.getRoadMapDestAdressId() == null ? other.getRoadMapDestAdressId() == null : this.getRoadMapDestAdressId().equals(other.getRoadMapDestAdressId()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getRoadMapDestAdressId() == null) ? 0 : getRoadMapDestAdressId().hashCode());
