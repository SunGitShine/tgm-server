...
public class TaskDeviceExample {
    ...
    public TaskDeviceExample orderBy(String ... orderByClauses) {
    ...
    public TaskDeviceExample limit(int pageNo, int pageSize) {
        this.size = pageSize;
    ...
    public static class Criteria extends GeneratedCriteria {
        private TaskDeviceExample example;

        protected Criteria(TaskDeviceExample example) {
            super();
            this.example = example;
        }

        public TaskDeviceExample example() {
            return this.example;
        }
    }
